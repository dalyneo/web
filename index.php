		...
		<div class="row">
					...
					<div class="product-thumb">
						...
						<div class="preview-meta">
							<ul>
								...
								<li>
									<a href="login.html"><i class="tf-ion-android-cart"></i></a>
								</li>
							</ul>
                      	</div>
					</div>
					<div class="product-content">
						<h4><a href="login.html">BAPDAHL</a></h4>
			...
			<div class="col-md-4">
				<div class="product-item">
					...
					<div class="product-content">
						<h4><a href="login.html">Clean Hand</a></h4>
						<p class="price">230dt</p>
					</div>
				</div>
			</div>
			<div class="col-md-4">
				<div class="product-item">
					...
					<div class="product-content">
						<h4><a href="login.html">GALAXIE RS</a></h4>
						<p class="price">200dt</p>
					</div>
				</div>
			</div>
			<div class="col-md-4">
				<div class="product-item">
					...
					<div class="product-content">
						<h4><a href="login.html">Motul</a></h4>
						<p class="price">180dt</p>
					</div>
				</div>
			</div>
			<div class="col-md-4">
				<div class="product-item">
					...
					<div class="product-content">
						<h4><a href="login.html">Mobil ATF</a></h4>
			...
			<div class="col-md-4">
				<div class="product-item">
					...
					<div class="product-content">
						<h4><a href="login.html">YACCO</a></h4>
			...
			<div class="col-md-4">
				<div class="product-item">
					...
					<div class="product-content">
						<h4><a href="login.html">VARTA</a></h4>
						<p class="price">165dt</p>
					</div>
				</div>
			</div>
			<div class="col-md-4">
				<div class="product-item">
					...
					<div class="product-content">
						<h4><a href="login.html">SYNTIUM</a></h4>
						<p class="price">175dt</p>
					</div>
				</div>
			</div>
		...
		<div class="row">
			<div class="col-md-12 text-center">
				<div class="title">
					...
					<p>Subscribe to receive content and notification.</p>
				</div>
